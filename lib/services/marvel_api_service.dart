...
import 'package:actividad_05/constants.dart';
...
class MarvelApiService {
  ...
  Future<MarvelResponse<Character>> getCharacter(int characterId) =>
      http
          .get(_buildUri('/characters/$characterId',
              queryParams: null))
          .then((response) =>
  ...
  Future<MarvelResponse<Serie>> getSerie(int serieId) =>
      http
          .get(_buildUri('/series/$serieId', queryParams: null))
          .then(
              (response) => MarvelResponse<Serie>.fromRawJson(response.body));
  ...
  Future<MarvelResponse<Comic>> getComic(int comicId) =>
      http
          .get(_buildUri('/comics/$comicId', queryParams: null))
          .then(
  ...
  Future<MarvelResponse<MarvelEvent>> getEvent(int eventId) =>
      http
          .get(_buildUri('/events/$eventId', queryParams: null))
          .then(
              (response) => MarvelResponse<MarvelEvent>.fromRawJson(response.body));
  ...
  Future<MarvelResponse<Creator>> getCreator(int creatorId) =>
      http
          .get(_buildUri('/creators/$creatorId',
              queryParams: null))
          .then((response) =>
